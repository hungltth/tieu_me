...
def add_header_block(doc):
    ...
    add_run(q3, "Thành phố Hà Nội, ngày 22 tháng 07 năm 2026", size=13, italic=True)
    return table
...
out_path = "/Users/hung/Projects/private/tieu_me/workspace/bao_cao/20260722_don_dang_ky_NEXUS_dau_thau.docx"
doc.save(out_path)
